...
/**********************************************************************************
 * 
 * Inherit from superclass BotWars_Multiplayer and add Bluetooth specific
 * implementation
 * 
 **********************************************************************************/
...
public class Multiplayer_BT extends BotWars_MultiPlayer {
	...
	private void initBT() {
		...
		try {
			...
			Toast.makeText(Multiplayer_BT.this, "UNKNOWN SERVER ADDRESS", 100)
					.show();
		} catch (IOException e) {

			Toast.makeText(Multiplayer_BT.this, "ERROR CREATING SOCKET", 100)
					.show();
		}
	 ...
	 * socket and stop receiving thread
	 * 
	 **********************************************************************************/
	@Override
	 ...
	 * mechanism to read from inputStream of socket and return incoming message
	 * 
	 **********************************************************************************/
	@Override
	 ...
	 * mechanism to write given String to outputStream
	 * 
	 **********************************************************************************/
